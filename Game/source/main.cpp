...
void Time(int value)
{
    ...
    if(!fimdeturno && !Pausa && !ajuda)
    {
        ...
        if((bola.Posicao[1] < R1.Posicao[2] + 11 && bola.Posicao[1] > R1.Posicao[2] - 41) &&
           bola.Posicao[0] > R1.Posicao[0] - 30 && bola.Posicao[0] < R1.Posicao[0] + 30)
        {
        ...
        if((bola.Posicao[1] > R2.Posicao[2] - 11 && bola.Posicao[1] < R2.Posicao[2] + 41) &&
           bola.Posicao[0] > R2.Posicao[0] - 30 && bola.Posicao[0] < R2.Posicao[0] + 30)
        {
        ...
        if(bola.Velocidade[1] >= -atc && bola.Velocidade[1] <= atc && bola.Velocidade[0] <= atc &&
           bola.Velocidade[0] >= -atc && !saque)
        {
            if(bola.Posicao[1] > 0)
            {
                ptp2++;
