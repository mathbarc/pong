...
void DesenhaPlacar() {
  ...
  if (ptp1 == 0 || ptp1 == 4 || ptp1 == 5 || ptp1 == 6 || ptp1 == 8 ||
      ptp1 == 9) {
  ...
  if (ptp1 == 0 || ptp1 == 2 || ptp1 == 3 || ptp1 == 5 || ptp1 == 6 ||
      ptp1 == 7 || ptp1 == 8 || ptp1 == 9) {
  ...
  if (ptp2 == 0 || ptp2 == 4 || ptp2 == 5 || ptp2 == 6 || ptp2 == 8 ||
      ptp2 == 9) {
  ...
  if (ptp2 == 0 || ptp2 == 2 || ptp2 == 3 || ptp2 == 5 || ptp2 == 6 ||
      ptp2 == 7 || ptp2 == 8 || ptp2 == 9) {
...
void Desenha(void) {
  ...
  if (ptp1 == 9 || ptp2 == 9) {
    if (ptp1 == 9)
      ...
      sprintf(texto, "Jogador 2 ganhou o jogo");
...
void Inicializa(void) {
  ...
  GLfloat posicaoLuz[4] = {float(pluz[0]), float(pluz[1]), float(pluz[2]),
                           float(pluz[3])};
...
void EspecificaParametrosVisualizacao(void) {
  ...
  gluLookAt(pcamera[0], pcamera[1], pcamera[2], fcam[0], fcam[1], fcam[2], 0, 1,
            0);
}
...
void Time(int value) {
  ...
  if (!fimdeturno && !Pausa && !ajuda) {
    ...
    bola.VelocidadeTotal = sqrt(bola.Velocidade[1] * bola.Velocidade[1] +
    ...
    if (bola.Velocidade[0] != 0 || bola.Velocidade[1] != 0) {
      mod = sqrt(bola.Velocidade[0] * bola.Velocidade[0] +
    ...
    if ((bola.Posicao[1] < R1.Posicao[2] + 11 &&
         bola.Posicao[1] > R1.Posicao[2] - 41) &&
        bola.Posicao[0] > R1.Posicao[0] - 30 &&
        bola.Posicao[0] < R1.Posicao[0] + 30) {
    ...
    if ((bola.Posicao[1] > R2.Posicao[2] - 11 &&
         bola.Posicao[1] < R2.Posicao[2] + 41) &&
        bola.Posicao[0] > R2.Posicao[0] - 30 &&
        bola.Posicao[0] < R2.Posicao[0] + 30) {
    ...
    if (bola.Posicao[1] == R2.Posicao[2] - 11 && saque)
      bola.Posicao[0] = R2.Posicao[0];
    if (bola.Posicao[1] == R1.Posicao[2] + 11 && saque)
      bola.Posicao[0] = R1.Posicao[0];

    // controle de pontos quando a bola para
    if (bola.Velocidade[1] >= -atc && bola.Velocidade[1] <= atc &&
        bola.Velocidade[0] <= atc && bola.Velocidade[0] >= -atc && !saque) {
      if (bola.Posicao[1] > 0) {
        ptp2++;
        bola.Velocidade[1] = 0;
        bola.Velocidade[0] = 0;
